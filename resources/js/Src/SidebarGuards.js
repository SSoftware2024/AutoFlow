                    ...
                    items: [
                        {
                            label: 'Novo',
                            icon: 'fa-solid fa-user-plus',
                            command: () => router.get(window.route('user.driving_school.students.createView'))
                        },
                        {
                            label: 'Lista',
                            icon: 'fa-solid fa-list',
                            command: () => router.get(window.route('user.driving_school.students.index'))
                        },
                    ]
                },
                {
                    ...
                    items: [
                        {
                            label: 'Novo',
                            icon: 'fa-solid fa-user-plus',
                            command: () => router.get(window.route('user.driving_school.teacher.createView'))
                        },
                        {
                            label: 'Lista',
                            icon: 'fa-solid fa-list',
                            command: () => router.get(window.route('user.driving_school.teacher.index'))
                        },
                    ]
                },
                {
                    ...
                    items: [
                        {
                            label: 'Novo',
                            icon: 'fa-solid fa-user-plus',
                            command: () => router.get(window.route('user.driving_school.operator_cashier.createView'))
                        },
                        {
                            label: 'Lista',
                            icon: 'fa-solid fa-list',
                            command: () => router.get(window.route('user.driving_school.operator_cashier.index'))
                        },
                    ]
                }
            ]
