        ...
        <form enctype="multipart/form-data">
            <div class="row-col">
                <div class="mb-3 center-col row-col">
                    <div class="relative">
                        <img v-if="!page.props.company.logo && !image " :src="page.props.images.company" class="max-w-[94px]" />
                        ...
                        <Image alt="Image" preview v-else-if="!image && page.props.company.logo">
                            <template #image>
                                <img :src="page.props.company.logo_url.thumbmail" alt="image"
                                    class="w-[100px]" />
                            </template>
                            <template #preview="slotProps">
                                <img :src="page.props.company.logo_url.default" alt="preview"
                                    :style="slotProps.style" @click="slotProps.previewCallback" />
                            </template>
                        </Image>
                        <div class="flex flex-row justify-end w-full">
                            <a v-if="page.props.company.logo || image" class="underline cursor-pointer text-danger-600 hover:font-bold"
            ...
            <div class="row-col">
                ...
                <InputMask id="cnpj" v-model="form.cnpj" mask="99.999.999/9999-99" placeholder="99.999.999/9999-99" :class="{
...
function deleteImage() {
    if(image.value){
        ...
        //deletar apenas a foto do banco
    }
}
</script>
