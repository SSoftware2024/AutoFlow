                ...
                <div class="my-1 row">
                    <div class="row-col">
                        <div class="flex cursor-pointer align-items-center">
                            <Checkbox v-model="form.responsible" inputId="responsible" :binary="true" disabled
                                @click="_alertGoControlResponsive" />
                            <label for="responsible" class="ml-2 cursor-pointer" @click="_alertGoControlResponsive">
                                Responsável </label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="row-col">
                        ...
                        <Dropdown v-model="form.company_id" :options="page.props.companies" optionLabel="name"
                            optionValue="id" placeholder="Selecione" class="w-full" filter :disabled="form.responsible"
                            :class="{
                                'p-invalid': form.errors.company_id
                            }" />
